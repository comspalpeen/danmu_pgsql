...
class User(betterproto.Message):
    ...
    new_badge_image_list: List["Image"] = betterproto.message_field(61)
    badge_display_info: "BadgeDisplayInfo" = betterproto.message_field(78)
...
class BadgeStruct(betterproto.Message):
    badge_type: int = betterproto.uint32_field(1)
    image: "Image" = betterproto.message_field(2)


@dataclass(eq=False, repr=False)
class BadgeDisplayInfo(betterproto.Message):
    """勋章显示信息，对应 78"""

    badge_list: List["BadgeStruct"] = betterproto.message_field(1)
    display_order: str = betterproto.string_field(2)
...
@dataclass(eq=False, repr=False)
class WebcastPrivilegeScreenChatMessage(betterproto.Message):
    common: "Common" = betterproto.message_field(1)
    user: "User" = betterproto.message_field(2)
    content: str = betterproto.string_field(3)
...
class LinkMicBattleFinishMethod(betterproto.Message):
    """PK结束/结算消息  基于抓包数据 1vs7.txt, 2v2.txt 修正"""
...
class BattleFinishInfo(betterproto.Message):
    ...
    duration: int = betterproto.uint64_field(4)
    channel_id: int = betterproto.uint64_field(6)
...
class BattleResultContributorItem(betterproto.Message):
    ...
    """Field 3 是复杂结构，有时是 map，有时包含 Tag 在 1vs7.txt 中是 {1:1, 2:3}"""
